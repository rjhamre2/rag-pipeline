faq_data = {
    ...
    "Why will 'My Cashback' not be available on Myntra?": "To make your shopping experience easier and simpler, 'My Cashback' will be replaced by PhonePe. PhonePe wallet can be used on Myntra and other PhonePe partners. To use your PhonePe balance, you will have to activate/verify your PhonePe account",
    
    "How do I cancel the order, I have placed?": "Order can be canceled till the same is out for delivery. Note: This may not be applicable for certain logistics partner. You would see an option to cancel within 'My Orders' section under the main menu of your App/Website/M-site then select the item or order you want to cancel. In case you are unable to cancel the order from'My Orders' section, you can refuse it at the time of delivery and refund will be processed into the source account, if order amount was paid online.",
    
    "How do I create a Return Request?": "You can create a Return in three simple steps: 1) Tap on MyOrders 2) Choose the item to be Returned 3) Enter details requested and create a return request",
    
    "I have created a Return request. When will the product be picked up?": "Number of days to pickup a product may vary as per the Logistics team that will be assigned to pickup your product. The product will be picked anywhere between 4 – 7 days.",
    
    "I have created a Return request. When will I get the refund?": "Refund will be initiated upon successful pickup as per the Returns Policy. The refund amount is expected to reflect in the customer account within the following timelines: NEFT - 1 to 3 business days post refund initiation, Myntra Credit - Instant, Online Refund – 7 to 10 days post refund initiation, depending on your bank partner, 'PhonePe wallet' – Instant",
    ...
    "What is Myntra Studio, and how can I shop through Myntra Studio?": "Myntra Studio is an on-demand influencer-led content platform where you can view content (images/videos/polls/quizzes) posted by influencers and brands. You can also shop for select products featured on the Studio posts. You can access Studio by clicking on 'Studio' icon in the bottom navigation pane on the Myntra app. To shop for products featured on the post (or similar products), click on 'Shop Products' on the bottom left of the post.",
    ...
    "How can you sign up to be an influencer on Myntra Studio or Myntra Live?": "You can sign up to be an influencer on Myntra by registering on https://studio.galleri5.com/. Representatives from Myntra will reach out to you for the next steps.",
    
    "How do I redeem the MLive Coupons which I saw Influencers calling out in live streaming?": "The coupons that are shown in MLive will also be available on the cart page. Click on Apply Coupon option in cart page to view all the eligible coupons.",
    
    "What is Myntra's Platform Fee?": "Platform fee is levied by Myntra to sustain the efficient operations and continuous improvement of the platform, for a hassle-free app experience.",
    
    "What is Myntra's Shipping Fee?": "a) Shipping fee is charged towards providing delivery and post order services including but not limited to, higher than average returns b) Shipping is a value added service charge levied under one of the following circumstances: Orders below a certain value. The value can vary based on the category",
    
    "What is Myntra’s Fair Usage Policy?": "We always strive to provide the best experience to our customers. However, very rarely, there are some accounts that misuse Myntra's customer-friendly return service. These accounts typically return more items compared to an average user or frequently choose to not accept their shipments. Myntra reserves the rights to levy shipping fee on customers whose return rates are higher than average and are not adhering to the liberal returns service.",
    
    "I am an Insider. Why am I seeing the shipping fee?": "Shipping fee is a charge levied by Myntra, for the services rendered by Myntra on the platform. As an Insider, you continue to enjoy free shipping benefits without any minimum order value limits.",
    
    "How do I check the status of my order?": "Please tap on 'My Orders' section under main menu of App/Website/M-site to check your order status.",
    
    "How can I check if Myntra delivers to my PIN Code?": "You can find out if Myntra delivers to your PIN Code using the courier serviceability tool available on the product page. Please tap on 'Check Delivery options' and enter your area PIN code in the respective field to get the required information about standard order delivery time and availability of Cash on Delivery for the Product selected.",
    
    "How are orders placed on Myntra delivered to me?": "All orders placed on Myntra are dispatched through our own courier service - Myntra Logistics or through other courier partners such as Blue Dart, Delhivery Etc.",
    
    "Does Myntra deliver products outside India?": "No. At this point, Myntra delivers products only within India.",
    
    "How can I get my order delivered faster?": "Sorry, currently we do not have any service available to expedite the order delivery. In future, if we are offering such service and your area pincode is serviceable, you will receive a communication from our end.",
    
    "I have received a partial item/partial order or an Untenanted/Void packet?": "Kindly reach out to us for pilferage within 72 hours of delivery failing which the claim will not be entertained. Whilst we investigate, request you to please make note of the below pointers: Please do not use the item for which claim is being raised.",
    
    "What is Myntra's Cancellation Policy?": "You can now cancel an order when it is in packed/shipped status, as long as the cancel option is available on App/Website/M-site. This includes items purchased on sale also. Any amount paid will be credited into the same payment mode using which the payment was made",
    
    "Can I modify the shipping address of my order after it has been placed?": "Yes, You can modify the shipping address of your order before we have processed (packed) it, by updating it under 'change address' option which is available under 'My order' section of App/Website/M-site",
    
    "How do I cancel my Order?": "Tap on 'My Orders' section under the main menu of your App/Website/M-site and then select the item or order you want to cancel",
    ...
    "How do I create an account on Myntra?": "You can create your account on Myntra by entering and verifying your mobile number. Click on 'Create New Account' after that and fill up the form to create your Myntra account.",
    ...
    "What if I don't receive an OTP due to poor network connectivity?": "If you are not receiving an OTP use the 'Login with password' option to login to your Myntra account.",
    ...
    "Do I need to provide email to create an account on Myntra?": "Providing an email is not mandatory to create an account on Myntra. However, we still recommend adding your email to your account as it will allow you to easily reset your password if you need to.",

    "I have given my mobile number in my last order? Can I use that number to log in to Myntra?": "Mobile numbers given along with shipping address cannot be used to log in on Myntra. To use a number for login on Myntra, you need to add your number to your profile and verify it with OTP. This can be done under profile section in Account.",

    "What is account recovery on Myntra?": "Account recovery is the process of getting access to your account in case you have changed or lost your mobile number and did not change the mobile number on your Myntra account before you lost that number. This can be done by validating a saved credit/debit card expiry date (Myntra does not charge anything for this) or by entering an OTP sent to your alternate mobile number.",

    "Why am I asked for my credit card details to access my account?": "In case you do not have your mobile number with you anymore, Myntra can use a saved credit/debit card detail from your account, to match for expiry date and give you the option to change your password and update your new mobile number in your account. There is no charge made to the card in this process.",
    ...
    "How can i change my mobile number that I use to login on Myntra?": "You can log in to your account and change it from your Profile > Edit Profile.",

    "I do not have my old mobile number? How can I log into my account and change mobile number?": "You can update your account details by going to Account Recovery. For that, you will need to enter your old mobile number and go to the OTP page. You will find an option 'Get Help' there to recover your account.",

    "Does Myntra read my SMSes?": "Myntra can only read OTP SMSes that are sent by Myntra. This is in accordance with guidelines provided by Google and Apple in line with user privacy policies.",
